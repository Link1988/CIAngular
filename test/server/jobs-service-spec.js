...
describe("save jobs", function(){
    it("should validate that title is greater then 4 characters");
    it("should validate that title is less than 40 characters");
    it("should validate that description is greater then 4 characters");
    it("should validate that description is less than 250 characters");

    var newJob = {title: 'Cook', description: 'Yoll will be making bagels'};
    ...
    it("should return a status of 200 to the front and if the database saved");
    it("should return a job with an id");
    it("should return an error it the database failed");
})
